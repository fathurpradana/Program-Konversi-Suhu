/* 	Nama File		: 24343060_MuhammadFathurPradana_TUGAS4.c
	Programmer		: Muhammad Fathur Pradana
	Tgl. pembuatan	: Senin, 01 November 2024
...
int main() {
    printf("   Tugas 4 Fundamental Programming \n");
	printf("<====================================>\n");
    ...
    do {
        ...
        switch (pilihan) {
            ...
            case 4:
                ...
                fgets(judulCari, MAX_STRING, stdin);
                judulCari[strcspn(judulCari, "\n")] = 0; // Menghapus karakter newline
                hapusBuku(perpustakaan, &jumlahBuku, judulCari);
                break;
            case 5:
                printf("Masukkan judul buku yang ingin diedit: ");
                fgets(judulCari, MAX_STRING, stdin);
                judulCari[strcspn(judulCari, "\n")] = 0; // Menghapus karakter newline
                editBuku(perpustakaan, jumlahBuku, judulCari);
                break;
            case 6:
...
// Fungsi untuk mengedit informasi buku berdasarkan judul
void editBuku(struct Buku *perpustakaan, int jumlahBuku, char *judulEdit) {
    int ditemukan = 0;
    for (int i = 0; i < jumlahBuku; i++) {
